  ...
  return (
    <div className="container" style={{ paddingTop: '2rem', paddingBottom: '3rem' }}>
      ...
      <article style={styles.article}>
        ...
        {project.summary && <p style={styles.summary}>{project.summary}</p>}
        {project.description && <div style={styles.description}>{project.description}</div>}
        <div style={styles.links}>
          {project.url && (
            <a href={project.url} target="_blank" rel="noopener noreferrer" className="btn btn-primary">Demo</a>
          )}
          {project.repository_url && (
            <a href={project.repository_url} target="_blank" rel="noopener noreferrer" className="btn btn-outline">Repository</a>
          )}
        </div>
        {skills.length > 0 && (
